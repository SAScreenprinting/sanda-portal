  ...
  try {
    ...
    if (status === 'Approved') {
      ...
      html = page({
        ...
        body: `<strong>${esc(design.name)}</strong> (${esc(product)}) has been reviewed and approved. S&amp;A will now set it up with your POD profile and your online stores. We will keep you posted on your Designs page.`,
